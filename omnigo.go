...
// It extends the base llm.LLM interface with additional functionality specific to omnigo,
...
type LLM interface {
	...
	GetModel() string
	// UpdateLogLevel changes the logging verbosity for both omnigo and internal LLM operations.
...
// It supports caching and provider-specific optimizations.
//
